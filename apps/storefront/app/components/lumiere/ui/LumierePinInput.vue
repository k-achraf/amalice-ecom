...
// Lumiere's OTP pin input — plain <input> boxes + Tailwind, no @nuxt/ui.
...
<template>
  <div class="flex justify-center gap-2" @paste="onPaste">
    <input
      ...
      maxlength="1"
      class="size-12 rounded border border-black/20 bg-white text-center text-xl font-bold tabular-nums text-black transition-colors duration-150 focus:border-primary-600 focus:outline-none sm:size-14"
