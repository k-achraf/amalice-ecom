    ...
    <div class="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
      ...
      <div class="flex flex-col items-start justify-between gap-6 border-b border-white/10 pb-8 sm:flex-row sm:items-center">
        <div>
          ...
          <p class="mt-2 max-w-sm text-sm text-white/50">الدفع عند الاستلام، بدون حساب. ادفع عند وصول طلبك.</p>
        </div>
      ...
      <div class="grid grid-cols-1 divide-y divide-white/10 pt-8 sm:grid-cols-3 sm:divide-x sm:divide-y-0">
        <div class="pb-6 sm:pb-0 sm:pe-8">
          <h3 class="spec-badge">المتجر</h3>
          <ul class="mt-3 space-y-2 text-sm text-white/60">
            <li><NuxtLink to="/catalog" class="transition-colors hover:text-white">كل المنتجات</NuxtLink></li>
            ...
            <li><NuxtLink to="/deals" class="transition-colors hover:text-white">عروض اليوم</NuxtLink></li>
            <li><NuxtLink to="/new-arrivals" class="transition-colors hover:text-white">وصل حديثاً</NuxtLink></li>
          </ul>
        </div>

        <div class="py-6 sm:px-8">
          <h3 class="spec-badge">المساعدة</h3>
          <ul class="mt-3 space-y-2 text-sm text-white/60">
            <li><NuxtLink to="/contact" class="transition-colors hover:text-white">اتصل بنا</NuxtLink></li>
            <li><NuxtLink to="/faq" class="transition-colors hover:text-white">الأسئلة الشائعة</NuxtLink></li>
            <li><NuxtLink to="/shipping" class="transition-colors hover:text-white">الشحن</NuxtLink></li>
            <li><NuxtLink to="/returns" class="transition-colors hover:text-white">الإرجاع</NuxtLink></li>
            <li><NuxtLink to="/track" class="transition-colors hover:text-white">تتبع الطلب</NuxtLink></li>
          </ul>
        </div>

        <div class="pt-6 sm:ps-8 sm:pt-0">
          <h3 class="spec-badge">الشركة</h3>
          <ul class="mt-3 space-y-2 text-sm text-white/60">
            <li><NuxtLink to="/about" class="transition-colors hover:text-white">من نحن</NuxtLink></li>
            <li><NuxtLink to="/blog" class="transition-colors hover:text-white">المدونة</NuxtLink></li>
            <li><NuxtLink to="/careers" class="transition-colors hover:text-white">الوظائف</NuxtLink></li>
            <li><NuxtLink to="/terms" class="transition-colors hover:text-white">الشروط</NuxtLink></li>
            <li><NuxtLink to="/privacy" class="transition-colors hover:text-white">الخصوصية</NuxtLink></li>
          </ul>
        </div>
      </div>
      ...
      <div class="mt-10 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-6 sm:flex-row">
        <p class="text-xs text-white/40">© {{ year }} {{ settings.storeName }}. تجارة الدفع عند الاستلام.</p>
        <div class="font-mono-spec flex items-center gap-4 text-[11px] uppercase tracking-wide text-white/40">
          ...
          <span class="flex items-center gap-1"><Icon name="i-lucide-shield-check" class="size-3.5" /> موثّق</span>
        </div>
      </div>
    </div>
  </footer>
