...
// Trove new arrivals — a light cream header band, circle-on-sharp-frame
// grid of the newest finds.
  ...
  <div>
    <div class="border-b border-neutral-200 bg-[var(--color-trove-cream)]">
      <div class="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
        <nav class="mb-4 flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-neutral-400">
        ...
        <span class="trove-tag"><Icon name="i-lucide-sparkles" class="size-3" /> Just landed</span>
        <h1 class="font-display mt-4 text-3xl text-[var(--color-trove-ink)] sm:text-4xl lg:text-5xl">New in the trove</h1>
        <p class="mt-3 max-w-xl text-neutral-600">Fresh finds for your everyday carry. Cash on delivery — pay when it lands at your door.</p>
      </div>
    </div>
