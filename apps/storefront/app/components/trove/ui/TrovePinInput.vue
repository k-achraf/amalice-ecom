...
// Trove's OTP pin input — plain <input> boxes + Tailwind, no @nuxt/ui.
// Sharp-cornered boxes (inputs stay sharp — only photos get to be round),
...
<template>
  <div class="flex justify-center gap-2.5" @paste="onPaste">
    <input
      ...
      maxlength="1"
      class="size-12 rounded border border-neutral-200 bg-white text-center text-xl font-bold tabular-nums text-[var(--color-trove-ink)] transition-all duration-200 focus:border-primary-500 focus:shadow-[var(--shadow-trove-sm)] focus:outline-none sm:size-14"
