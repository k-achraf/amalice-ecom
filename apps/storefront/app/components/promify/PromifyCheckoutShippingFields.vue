...
// Cart+checkout flow's wilaya/commune/shipping picker for Promify — mirrors
// CheckoutShippingFields.vue's cascade logic (GET /wilayas + GET /communes?wilayaId=)
// but built on Promify's own primitives instead of @nuxt/ui, matching
// PromifyLeadFormFields.vue's visual conventions.
//
...
<template>
  <div class="space-y-3">
    <div class="grid grid-cols-2 gap-3">
      <div class="space-y-1">
        <label class="block text-xs font-medium text-neutral-600">Wilaya</label>
        <PromifySelect
      ...
      <div class="space-y-1">
        <label class="block text-xs font-medium text-neutral-600">Commune</label>
        <PromifySelect
    ...
    <div v-if="selectedWilaya" class="space-y-1.5">
      <label class="block text-xs font-medium text-neutral-600">Shipping method</label>
