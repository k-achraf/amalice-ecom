...
// Promify's OTP pin input — plain <input> boxes + Tailwind, no @nuxt/ui.
...
<template>
  <div class="flex justify-center gap-2" @paste="onPaste">
    <input
      ...
      maxlength="1"
      class="size-12 rounded-lg border border-neutral-200 bg-white text-center text-xl font-semibold tabular-nums text-neutral-900 transition-all duration-150 focus:border-primary-500 focus:shadow-[0_0_0_4px_rgba(99,91,255,0.15)] focus:outline-none sm:size-14"
