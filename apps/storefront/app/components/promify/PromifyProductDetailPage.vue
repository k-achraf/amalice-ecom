...
<template>
  <div v-if="props.product" class="bg-neutral-50">
    ...
    <section class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <img v-if="props.landingPageImageUrl" :src="props.landingPageImageUrl" :alt="props.product.name" class="mb-10 w-full rounded-2xl" />
        ...
        <div class="space-y-6">
          ...
          <div v-if="props.offers?.length" class="space-y-2">
            <button
              ...
              :key="offer.id"
              type="button"
              class="flex w-full items-center justify-between rounded-full border-2 px-4 py-2 text-left text-sm font-medium transition-all"
              :class="props.selectedOfferId === offer.id ? 'border-primary-600 bg-primary-50 text-primary-700 ring-2 ring-primary-200' : 'border-neutral-200 text-neutral-700 hover:border-primary-400 hover:text-primary-600'"
          ...
          <div class="lg:sticky lg:top-24">
            ...
            <div v-if="props.displayCart !== false" class="rounded-2xl border border-neutral-100 bg-white p-6 shadow-[var(--shadow-promify-md)]">
              ...
              <div class="space-y-2 border-t border-neutral-100 pt-4 text-sm">
                <div class="flex items-center justify-between"><span class="text-neutral-500">Subtotal</span><PriceDisplay :amount-cents="props.offerTotalCents ?? props.effectivePriceCents * props.quantity" class="font-medium text-neutral-900" /></div>
              ...
              <div class="mt-4 flex items-center justify-between border-t border-neutral-100 pt-4">
                ...
                <PriceDisplay :amount-cents="props.offerTotalCents ?? props.effectivePriceCents * props.quantity" class="text-xl font-bold text-neutral-900" />
              </div>
            ...
            <div v-if="props.displayCart === false && props.inStock" class="rounded-2xl border border-neutral-100 bg-white p-6 shadow-[var(--shadow-promify-md)] space-y-4">
              ...
              <div class="flex items-center justify-between border-t border-neutral-100 pt-4">
                <span class="text-base font-semibold text-neutral-900">Total</span>
                <PriceDisplay :amount-cents="(props.offerTotalCents ?? props.effectivePriceCents * props.quantity) + (props.leadShippingPriceCents ?? 0)" class="text-xl font-bold text-neutral-900" />
              </div>
              <div class="flex items-center gap-3">
