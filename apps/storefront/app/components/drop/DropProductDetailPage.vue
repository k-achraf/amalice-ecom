...
<template>
  <div v-if="props.product" class="bg-black">
    ...
    <section class="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div class="relative grid grid-cols-1 gap-10 lg:grid-cols-5">
        ...
        <div class="space-y-6 lg:col-span-2">
          ...
          <div v-if="props.displayCart !== false" class="border border-white/10 bg-[#171717] p-6">
            ...
            <div class="space-y-2 border-t border-white/10 pt-4 text-sm">
              <div class="flex items-center justify-between"><span class="text-white/40">Subtotal</span><PriceDisplay :amount-cents="props.effectivePriceCents * props.quantity" class="font-bold text-white" /></div>
            ...
            <div class="mt-4 flex items-center justify-between border-t border-white/10 pt-4">
              ...
              <PriceDisplay :amount-cents="props.effectivePriceCents * props.quantity" class="text-xl font-bold text-white" />
            </div>
