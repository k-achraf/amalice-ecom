...
// step indicator is rounded dots, OTP uses PulsePinInput.
            ...
            <div class="lg:col-span-2">
              <div class="glow-card p-6 sm:p-8">
                  ...
                  <form class="space-y-5" @submit.prevent="submitAddress">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <PulseInput v-model="props.form.address.city" />
                      ...
                      <div>
                        ...
                        <PulseInput v-model="props.form.address.region" />
                    ...
                    <div class="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <PulseInput v-model="props.form.address.postalCode" />
                      ...
                      <div>
                        ...
                        <PulseInput v-model="props.form.address.country" :maxlength="2" class="uppercase" />
                ...
                <div v-else-if="props.step === 'otp'">
                  <h2 class="font-display mb-1 text-2xl text-neutral-900">Confirm your order</h2>
                  ...
                  <div class="rounded-2xl bg-neutral-50 p-6">
                    <PulsePinInput v-model="props.otpCode" :length="6" />
                  </div>
                  <PulseAlert v-if="props.otpError" color="error" :description="props.otpError" class="mt-4" />
                  <PulseButton block size="lg" :loading="props.verifying" :disabled="props.otpCodeString.length !== 6" class="mt-6" @click="props.onVerifyCode">Confirm order</PulseButton>
                  <PulseButton variant="ghost" color="neutral" block class="mt-2" :disabled="props.resendCooldown > 0" @click="props.onResendCode">
