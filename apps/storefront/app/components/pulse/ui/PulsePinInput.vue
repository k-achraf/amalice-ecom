...
// Pulse's OTP pin input — plain <input> boxes + Tailwind, no @nuxt/ui.
// Rounded-2xl boxes, auto-advances focus on digit entry, steps back on
...
<template>
  <div class="flex justify-center gap-2.5" @paste="onPaste">
    <input
      ...
      maxlength="1"
      class="size-12 rounded-2xl border border-neutral-200 bg-white text-center text-xl font-semibold tabular-nums text-neutral-900 transition-all duration-200 focus:border-primary-400 focus:shadow-[var(--shadow-pulse-sm)] focus:outline-none sm:size-14"
