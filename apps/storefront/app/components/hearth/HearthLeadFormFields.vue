...
// Hearth's lead-form field renderer — same logic as the shared
// LeadFormFields (rows grouping, wilaya→commune cascade backed by GET
// /wilayas + GET /communes?wilayaId=), but built on Hearth's own primitives
...
<template>
  <div class="space-y-4">
    ...
    <div v-if="selectedWilaya" class="space-y-1.5">
      <label class="block text-xs font-medium uppercase tracking-wide text-neutral-500">Shipping method</label>
