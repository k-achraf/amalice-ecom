...
// Atelier's lead-form field renderer — same logic as the shared
// LeadFormFields (rows grouping, wilaya→commune cascade backed by GET
// /wilayas + GET /communes?wilayaId=), but built on Atelier's own
// primitives instead of @nuxt/ui, since Atelier renders zero @nuxt/ui
// components anywhere.
