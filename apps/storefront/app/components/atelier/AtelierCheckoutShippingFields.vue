...
// Atelier's cart+checkout flow wilaya/commune/shipping picker — mirrors
// CheckoutShippingFields.vue's cascade logic (GET /wilayas + GET
// /communes?wilayaId=) but rendered with Atelier's own primitives
// (AtelierSelect) and card-button shipping styling instead of @nuxt/ui,
// since Atelier renders zero @nuxt/ui components anywhere.
//
  ...
  <div class="space-y-4">
    <div class="grid grid-cols-2 gap-3">
      <div class="space-y-1.5">
        <label class="block text-xs font-medium uppercase tracking-wide text-neutral-500">الولاية</label>
        <AtelierSelect
      ...
      <div class="space-y-1.5">
        <label class="block text-xs font-medium uppercase tracking-wide text-neutral-500">البلدية</label>
        <AtelierSelect
