  ...
  <div>
      ...
      <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        ...
        <div class="mt-8 flex items-center gap-3">
          ...
          <div class="flex items-center gap-3">
            <div class="flex size-16 flex-col items-center justify-center border-2 border-primary-500 bg-white/5">
    ...
    <section class="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
      <div class="mb-8 flex items-end justify-between">
        ...
        <NovaButton to="/catalog" variant="outline" trailing-icon="i-lucide-arrow-right">Browse all</NovaButton>
      </div>
        ...
        <div v-for="p in props.data.items" :key="p.id" class="space-y-2">
          ...
          <div class="border-2 border-black bg-white px-3 py-2">
            <div class="mb-1 flex items-center justify-between text-[11px] font-bold uppercase">
              <span class="text-black/50">Selling fast</span>
              <span :class="p.stockQuantity > 0 ? 'text-primary-700' : 'text-[var(--color-nova-pop)]'">
                {{ p.stockQuantity > 0 ? `${p.stockQuantity} left` : 'Sold out' }}
              </span>
            </div>
            <div class="h-2 w-full border border-black/20 bg-zinc-100">
              <div
      ...
      <NovaEmptyState v-else icon="i-lucide-package-search" title="No deals right now" description="Check back soon for our curated picks.">
