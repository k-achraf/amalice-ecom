              ...
              <div class="border-2 border-black bg-white p-6 shadow-[var(--shadow-nova-sm)] sm:p-8">
                ...
                <div v-if="props.step === 'address'">
                  ...
                  <form class="space-y-5" @submit.prevent="submitAddress">
                    ...
                    <NovaCheckoutShippingFields :form="props.form" />
                    <p v-if="props.addressError" class="mt-1 text-xs font-bold text-[var(--color-nova-pop)]">{{ props.addressError }}</p>
                ...
                <div v-else-if="props.step === 'review'">
                  ...
                  <div class="mt-4 space-y-1 border-2 border-black p-4 text-sm">
                    ...
                    <p class="text-black/70">{{ props.form.address.city }}, {{ props.form.address.region }}</p>
                    <p class="text-black/70">{{ props.form.phone }}</p>
                  </div>

                  <div class="mt-4 flex items-center justify-between border-2 border-black p-4 text-sm">
                    <span class="text-black/60">Shipping ({{ props.form.shippingType === 'Home' ? 'Home delivery' : 'Desk delivery' }})</span>
            ...
            <div class="lg:col-span-1">
              <div class="sticky top-24 border-2 border-black bg-white p-6 shadow-[var(--shadow-nova-md)]">
                ...
                <div class="space-y-2 border-t-2 border-black pt-4 text-sm">
                  ...
                  <div class="flex items-center justify-between"><span class="text-black/60">Shipping</span><span v-if="!props.form.shippingType" class="font-bold text-primary-700">Free</span><PriceDisplay v-else :amount-cents="props.form.shippingPriceCents" class="font-bold" /></div>
                </div>
