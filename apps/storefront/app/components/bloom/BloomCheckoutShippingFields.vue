...
// Bloom's cart+checkout flow wilaya/commune/shipping picker — same cascade
// logic as the shared CheckoutShippingFields.vue (GET /wilayas + GET
// /communes?wilayaId=), but built on Bloom's own primitives (BloomSelect)
// instead of @nuxt/ui, since Bloom renders zero @nuxt/ui components anywhere.
//
  ...
  <div class="space-y-4">
    <div class="grid grid-cols-2 gap-3">
      <div>
        ...
        <BloomSelect v-model="props.form.wilayaId" :items="wilayaItems" placeholder="اختر الولاية" />
      </div>
      <div>
