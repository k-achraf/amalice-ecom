...
// Bloom's OTP pin input — plain <input> boxes + Tailwind, no @nuxt/ui.
// Circular boxes (the round motif), auto-advances focus on digit entry,
...
<template>
  <div class="flex justify-center gap-2.5" @paste="onPaste">
    <input
      ...
      maxlength="1"
      class="size-12 rounded-full border border-neutral-200 bg-white text-center text-xl font-medium tabular-nums text-[var(--color-bloom-ink)] transition-all duration-200 focus:border-primary-300 focus:shadow-[var(--shadow-bloom-sm)] focus:outline-none sm:size-14"
