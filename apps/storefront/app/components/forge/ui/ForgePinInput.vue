...
// Forge's OTP pin input — plain <input> boxes + Tailwind, no @nuxt/ui.
...
<template>
  <div class="flex justify-center gap-2" @paste="onPaste">
    <input
      ...
      maxlength="1"
      class="tabular size-12 border-[3px] border-[var(--color-forge-ink)] bg-white text-center text-xl font-bold transition-colors duration-150 focus:border-primary-500 focus:bg-primary-50 focus:outline-none sm:size-14"
