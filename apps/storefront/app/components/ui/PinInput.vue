...
// Minimal's OTP pin input (the Polaris fallback) — plain <input> boxes +
// Tailwind, no @nuxt/ui.
...
<template>
  <div class="flex gap-2" @paste="onPaste">
    <input
      ...
      maxlength="1"
      class="size-11 rounded-md border border-default bg-default text-center text-lg font-medium tabular-nums text-highlighted focus:outline-none focus:ring-2 focus:ring-primary sm:size-12"
